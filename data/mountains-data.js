window.DMC_MOUNTAINS = [
  ...
  },
  {
    ...
    "courses": [
      {
        ...
        "sources": {
          ...
          "map": [
            {
              "label": "카카오맵 수락산",
              "url": "https://map.kakao.com/link/search/수락산"
            },
            {
              "label": "네이버지도 수락산",
              "url": "https://map.naver.com/p/search/수락산"
            }
          ],
          "review": [
            {
              "label": "등산가이드 수락산 코스",
              "url": "https://www.hiking-beginner.com/mountain/suraksan"
            }
          ]
        },
        "sourceNote": "코스 설명문은 출처 문장을 복사하지 않고 딕소톤 마운틴 클럽 톤으로 재작성했습니다.",
    ...
    "dataVerification": {
      "status": "후기/가이드 기반 초안",
      "officialCheck": "부분 확인 필요",
      "mapCheck": "수락산역·장암역·계곡 입구 지도 확인 필요",
      "reviewCheck": "코스명·거리·시간·난이도 참고",
      "updatedAt": "2026-07-03"
    }
  },
